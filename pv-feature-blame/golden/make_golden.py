...
def f_blame_true(t):
    return 50.0 + 10.0 * math.sin(2 * math.pi * hour_of(t) / 24.0)


def f_decoy_true(t):
    return 80.0 + 5.0 * math.cos(2 * math.pi * hour_of(t) / 24.0)


def f_good_true(t):
    return 20.0 + 2.0 * math.sin(2 * math.pi * hour_of(t) / 24.0 + 1.0)
...
def f_jumpy_decoy_true(t):
    return 40.0 + 3.0 * math.cos(2 * math.pi * hour_of(t) / 24.0)
