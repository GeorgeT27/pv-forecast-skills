...
用 `python3 "<ENGINE>/scripts/orient.py" --playbook model-comparison` 领阶段与 prereq；
生成脚本前必过 `python3 "<ENGINE>/scripts/gen_gate.py" --script <path> --playbook model-comparison --stage <n>`
