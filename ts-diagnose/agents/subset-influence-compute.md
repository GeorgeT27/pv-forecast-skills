...
用 `python3 "<ENGINE>/scripts/orient.py" --playbook subset-influence` 领阶段与 prereq；生成脚本前
必过 `python3 "<ENGINE>/scripts/gen_gate.py" --script <path> --playbook subset-influence --stage <n>`
